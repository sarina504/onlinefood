...
<div class="container-fluid" style="margin-top:98px">
	...
	<div class="row">
        <div class="col-lg-12">
         <button class="btn btn-primary float-right btn-sm" data-target="#newUser"><i class="fa fa-plus"></i> New user</button>
        </div>
	</div>
	    <br>
	<div class="row">
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    <td>' .$Id. '</td>
                                    <td><img src="/Onlinefood/img/person-' .$Id. '.jpg" alt="image for this user" onError="this.src =\'/Onlinefood/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' .$username. '</td>
                                    <td>
